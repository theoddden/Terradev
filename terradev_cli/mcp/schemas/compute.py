...
if Tool is not None:
    TOOLS = [
        ...
        Tool(name='provision_gpu', description='Provision GPU instances for optimal parallel efficiency', inputSchema={'type': 'object', 'properties': {'gpu_type': {'type': 'string', 'description': 'GPU type to provision', 'enum': ['H100', 'A100', 'A10G', 'L40S', 'L4', 'T4', 'RTX4090', 'RTX3090', 'V100']}, 'count': {'type': 'integer', 'description': 'Number of GPUs to provision', 'minimum': 1, 'default': 1}, 'providers': {'type': 'array', 'description': 'Cloud providers for parallel distribution', 'items': {'type': 'string', 'enum': ['runpod', 'vastai', 'aws', 'gcp', 'azure', 'tensordock', 'crusoe', 'digitalocean', 'hyperstack', 'siliconflow', 'latitude', 'huggingface', 'baseten', 'inferx', 'yottalabs', 'e2enetworks', 'gcore']}}, 'max_price': {'type': 'number', 'description': 'Maximum price per hour', 'minimum': 0}, 'plan_only': {'type': 'boolean', 'description': 'Generate plan without applying', 'default': False}, 'state_file': {'type': 'string', 'description': 'State file path (optional)', 'default': None}}, 'required': ['gpu_type']}),
