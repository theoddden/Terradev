...
if Tool is not None:
    TOOLS = [
        ...
        Tool(name='price_discovery', description='Enhanced price discovery with capacity scoring, confidence intervals, and trend analysis.', inputSchema={'type': 'object', 'properties': {'gpu_type': {'type': 'string', 'description': 'GPU type', 'enum': ['H100', 'H200', 'H800', 'A100', 'A10G', 'L40S', 'L4', 'T4', 'RTX4090', 'V100S', 'A6000', 'MI300X']}, 'region': {'type': 'string', 'description': 'Filter by region'}, 'hours': {'type': 'integer', 'description': 'Hours of history', 'default': 24}}, 'required': ['gpu_type']}),
