...
if Tool is not None:
    TOOLS = [
        ...
        Tool(name='datadog_terraform_export', description='Generate a complete module for the Datadog integration: provider.tf, monitors.tf, dashboard.tf, versions.tf. Apply to deploy all monitors and dashboards as IaC.', inputSchema={'type': 'object', 'properties': {'output_dir': {'type': 'string', 'description': 'Directory to write .tf files (default: ./datadog-terraform)'}}}),
