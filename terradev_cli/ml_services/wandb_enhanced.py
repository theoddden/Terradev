...
class EnhancedWAndBService:
        ...
        try:
            ...
            variables = {
                "input": {
                    ...
                    "description": dashboard_config.get(
                        "description", "Dashboard created by Terradev"
                    ),
            ...
            variables = {
                "input": {
                    ...
                    "description": report_config.get(
                        "description", "Report created by Terradev"
                    ),
                    "entityName": self.config.entity or "default",
                    "projectName": self.config.project or "terradev",
        ...
        try:
            ...
            variables = {
                "input": {
                    ...
                    "description": alert_config.get(
                        "description", "Alert created by Terradev"
                    ),
                    "entityName": self.config.entity or "default",
                    "projectName": self.config.project or "terradev",
    ...
    def get_wandb_config(self) -> Dict[str, str]:
        ...
        config = {"WANDB_API_KEY": self.config.api_key}
...
def create_enhanced_wandb_service_from_credentials(
    credentials: Dict[str, str]
) -> EnhancedWAndBService:
    ...
    config = WAndBEnhancedConfig(
        ...
        integration_enabled=credentials.get("integration_enabled", "false").lower()
        == "true",
    )
