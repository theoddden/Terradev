...
class PrefixCacheIndex:
    ...
    def record(
        ...
        # KV cache? For a hit/partial hit it's the matched portion. For a miss
        # that primes the cache it's the whole prompt, but only if the prompt
        # is at least one KV block (otherwise the engine can't store it).
