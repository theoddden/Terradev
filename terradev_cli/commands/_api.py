...
def run_interactive_onboarding(api: TerradevAPI):
    ...
    provider_configs = {
        ...
        "huggingface": {
            ...
            "why": "Serverless inference and dedicated GPU endpoints",
        },
        "baseten": {
            "name": "Baseten",
            "key_name": "API Key",
            ...
            "why": "Model deployment platform with GPU serving",
        },
        "hyperstack": {
            "name": "Hyperstack",
            "key_name": "API Key",
            ...
            "why": "High-performance cloud GPU instances",
        },
        "digitalocean": {
            "name": "DigitalOcean",
            "key_name": "API Token",
        ...
        "siliconflow": {
            ...
            "why": "Fast inference API for LLMs",
        },
        "inferx": {
            "name": "InferX",
            "key_name": "API Key",
        ...
        "latitude": {
            ...
            "env_var": "LATITUDE_API_KEY",
            "why": "Bare metal GPU servers",
        },
        "yottalabs": {
            "name": "Yotta Labs",
            "key_name": "API Key",
            ...
            "env_var": "YOTTALABS_API_KEY",
            "why": "GPU cloud for AI workloads",
        },
        "gcore": {
            "name": "Gcore",
            "key_name": "API Token",
            ...
            "env_var": "GCORE_API_TOKEN",
            "why": "Global cloud with GPU instances",
        },
    }
