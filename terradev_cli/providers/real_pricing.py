...
class RealGPUPricing:
    ...
    async def get_azure_pricing(
        self, gpu_type: str, region: str = "eastus"
    ) -> List[Dict[str, Any]]:
    ...
    async def get_gcp_pricing(
        self, gpu_type: str, region: str = "us-central1"
    ) -> List[Dict[str, Any]]:
    ...
    async def get_runpod_pricing(
        self, gpu_type: str, region: str = "us-east"
    ) -> List[Dict[str, Any]]:
