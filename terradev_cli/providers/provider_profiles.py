...
PROVIDER_PROFILES: dict[str, ProviderProfile] = {
    ...
    "gcore": ProviderProfile(
        name="gcore",
        api_style="rest",
        auth_type="x_api_key",  # Authorization: APIKey {token}
        requires_instance_type_mapping=False,
        quote_method="get",
        provision_requires_location_id=True,
        egress_cost=0.0,
