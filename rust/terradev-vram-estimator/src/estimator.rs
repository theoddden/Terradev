...
impl VRAMEstimator {
    pub fn estimate_vram(
        ...
        let activation_cache_gb = Self::calculate_activation_cache(
            architecture,
            context_tokens,
            batch_size,
            &precision,
    ...
    fn calculate_kv_cache(
        ...
        let elements = (2 * architecture.num_layers * architecture.num_heads * head_dim * context_tokens * batch_size) as f64;
