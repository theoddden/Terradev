...
class PriceOptimizer:
            ...
            return {
                ...
                "lambda": {
                    "H100": {
                        "ondemand": 2.99,
                        "spot": 2.39,
                        "instance": "on-demand-h100",
                    },
                    "A100": {
                        "ondemand": 2.25,
                        "spot": 1.80,
                        "instance": "on-demand-a100",
                    },
                    "L40": {
                        "ondemand": 1.05,
                        "spot": 0.84,
                        "instance": "on-demand-l40",
                    },
                },
                "hyperstack": {
    ...
    def get_provider_prices(
        self, gpu_type: str, prefer_spot: bool
    ...
    def allocate_nodes(
        self, gpu_type: str, total_needed: int, max_price: float, prefer_spot: bool
    ) -> Dict:
        ...
        affordable_providers = [
            (p, price, instance, spot)
            for p, price, instance, spot in prices
            if price <= max_price
        ]
    ...
    def calculate_savings(self, allocation: Dict, gpu_type: str) -> Dict:
        ...
        multi_cloud_cost = sum(
            provider["total_cost"] for provider in allocation.values()
        )
...
def main():
    ...
    try:
        ...
        allocation = optimizer.allocate_nodes(
            gpu_type, total_needed, max_price, prefer_spot
        )
