...
class TestPhoenixService:
    ...
    def test_init_with_config(self):
        ...
        config = PhoenixConfig(
            collector_endpoint="http://localhost:6006", project_name="test-project"
        )
    ...
    def test_auth_header_format(self):
        ...
        # Cloud (with API key)
        config = PhoenixConfig(
            collector_endpoint="https://app.phoenix.arize.com", api_key="test-key"
        )
        service = PhoenixService(config)
        headers = service._get_auth_headers()
...
class TestGuardrailsService:
    ...
    def test_init_with_config(self):
        ...
        config = GuardrailsConfig(
            server_url="http://localhost:8090", llm_provider="openai", llm_model="gpt-4"
        )
...
class TestQdrantService:
    ...
    def test_init_with_config(self):
        ...
        config = QdrantConfig(
            url="http://localhost:6333", api_key="test-key", vector_size=768
        )
