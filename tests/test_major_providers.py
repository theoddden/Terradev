...
class TestAWSProvider:
    ...
    def test_auth_headers_with_key(self):
        ...
        provider = AWSProvider({"aws_access_key_id": "test", "aws_secret_access_key": "test"})
...
class TestProviderOutputSchemaConsistency:
    ...
    @pytest.mark.parametrize("provider_class,credentials", [
        (AWSProvider, {"aws_access_key_id": "test", "aws_secret_access_key": "test"}),
        (GCPProvider, {"gcp_project_id": "test", "gcp_credentials_path": "/path/to/creds.json"}),
        (AzureProvider, {"azure_subscription_id": "test", "azure_client_id": "test", "azure_client_secret": "test", "azure_tenant_id": "test"}),
    ])
