...
from terradev_cli.ml_services.vllm_service import VLLMConfig, LoRAModule, WorkloadProfile
...
class TestVLLMConfigSleepMode:
    ...
    def test_sleep_mode_levels(self):
        ...
        config1 = VLLMConfig(model_name="test-model", enable_sleep_mode=True, sleep_level=1)
        assert config1.sleep_level == 1
        
        # Level 2: discard weights
        config2 = VLLMConfig(model_name="test-model", enable_sleep_mode=True, sleep_level=2)
