...
from terradev_cli.core.training_orchestrator import TrainingConfig, _flashoptim_auto_config
...
class TestFlashOptimAutoConfigRules:
    ...
    def test_rule_6_reduced_precision(self):
        ...
        config = TrainingConfig(
            flashoptim="auto",
            script_args=["--bf16", "--learning-rate", "0.001"]
        )
        topology = {"nodes": {"node1": {"gpus": [{"memory_mb": 80000}]}}}
    ...
    def test_rule_6_fp16_detection(self):
        ...
        config = TrainingConfig(
            flashoptim="auto",
            script_args=["--fp16", "--learning-rate", "0.001"]
        )
        topology = {"nodes": {"node1": {"gpus": [{"memory_mb": 80000}]}}}
    ...
    def test_rule_7_large_total_vram(self):
        ...
        topology = {
            "nodes": {
                "node1": {"gpus": [{"memory_mb": 20000}, {"memory_mb": 20000}]}
            }
        }
...
class TestFlashOptimEnvVars:
    ...
    def test_master_weight_bits(self):
        ...
        config = TrainingConfig(
            flashoptim="on",
            flashoptim_master_weight_bits=32
        )
        topology = {"nodes": {"node1": {"gpus": [{"memory_mb": 80000}]}}}
    ...
    def test_compress_checkpoints(self):
        ...
        config = TrainingConfig(
            flashoptim="on",
            flashoptim_compress_checkpoints=True
        )
        topology = {"nodes": {"node1": {"gpus": [{"memory_mb": 80000}]}}}
